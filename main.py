...
# شعار الكلية مضمن مباشرة كبيانات نصية آمنة (يعمل فورا 100%)
LOGO_DATA_URI = "data:image/jpeg;base64,"
...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .logo-container img {{ width: 100%; max-height: 200px; object-fit: cover; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.5); border: 2px solid rgba(243,198,143,0.5); }}
            .category-title {{
...
def semester5():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>السداسي الخامس - منصة كلية الشريعة</title>
        <link href="https://fonts.googleapis.com/css2?family=Amiri:wght@400;700&display=swap" rel="stylesheet">
        <style>
            :root {
                --bg-base: #030a07;
...
def semester6():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>السداسي السادس - منصة كلية الشريعة</title>
        <link href="https://fonts.googleapis.com/css2?family=Amiri:wght@400;700&display=swap" rel="stylesheet">
        <style>
            :root {
                --bg-base: #030a07;
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="container">
                <div class="category-title"><span class="icon">🏛️</span> مقاييس السداسي السادس</div>
                <a href="/module/s6_module1" class="btn">مقياس قريباً (قيد الإعداد)</a>
            </div>
        </div>
        <footer>جميع الحقوق محفوظة منصة كلية الشريعة © 2026</footer>
    </body>
...
def manage_module(module_name):
    names_map = {
        ...
        's6_module1': 'مقاييس السداسي السادس'
    }
    ...
    <body>
        <div class="wrapper">
            <div class="top-nav">
                <a href="/semester5" class="back-btn">← العودة للخلف</a>
            </div>
